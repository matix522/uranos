...
pub fn delete(filename: &str) -> Result<usize, vfs::FileError> {
    let val: usize;
...
pub fn handle_delete(context: &mut ExceptionContext) {
    ...
    let val = vfs::delete_file(&filename);
